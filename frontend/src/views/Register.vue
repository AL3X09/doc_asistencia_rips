  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form @submit.prevent="submit">
        ...
        <input type="submit" class="fadeIn fourth" value="Registrar" :disabled="submitStatus === 'PENDING'"/>
      </form>
      <div>
        <b-alert
      ...
      <!-- Remind Passowrd -->
      <div id="formFooter">
        <a class="underlineHover" href="/">Ya estoy registrado</a>
      </div>
    </div>
  </div>
</template>
